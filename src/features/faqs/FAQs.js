      ...
      sections: [
        {
          ...
          items: [
            ...
            },
            {
              subtitle: "Pre-Order",
              content: [
                "A pre-order allows you to secure the latest statues before production is completed. Since resin statues are produced in limited quantities, stusioes only manufacture based on pre-order demand.",
            ...
            },
            {
              subtitle: "Sold-Out",
              content: [
                "The product is currently out of stock at BB Toys stores or at Stusioes, please contact us via media (facebook, instagram, wechat, tiktok, mail)",
              ],
            },
          ],
        },
          ...
          items: [
            {
              ...
              content: [
                ...
                "Not all stusioes can provide replacement parts, especially for products that have been released for a long time.",
      ...
      <div className="container-full mx-5">
        <div className="row">
          ...
          <div className="col-md-9">
            <div className="faqs-subcategories-wrapper">
              {renderSubcategories()}
            </div>
            <div className="faqs-content main-content">
              {activeItem ? (
